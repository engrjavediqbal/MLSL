...
def sigmoid_out(data):
    #return mx.sym.sigmoid(data, name='sigmoid')LogisticRegressionOutput 
    return mx.sym.LogisticRegressionOutput(data, name='sigmoid', grad_scale=0.04)
