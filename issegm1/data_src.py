...
class FileIter(DataIter):
    ...
    def _read(self, db_inds):
	    ...
	    #self._image_list[db_ind] = 'data/gta/images/15188.png'
	    #print 'Image Name :', self._image_list[db_ind]
		    ...
		    #output[k*locs_per_crop+j][2][i,:] = sigmLabels.reshape(1,1,19)
	...
	#return DataBatch(data=[array(data_batch[0])], label1=[array(data_batch[1])], label2=[array(data_batch[2:])])
