...
class FileIter(DataIter):
	...
	#print ('output batch:', type(output), len(output))
	    ...
	    if self._label_list[db_ind][0:8]=='gta2city':
		label1 = np.array(load_image_with_cache('data/cityscapes/gtFine/train/aachen/aachen_000000_000019_gtFine_labelIds.png', self._cache))
		print label1
